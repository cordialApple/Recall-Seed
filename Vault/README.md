...
| `update_experience` | patches an existing note by id — only the fields you pass change (per-beat text/confidence, skills/tags/metrics/entities/gaps as list replacements); answer a gap by filling its beat |
