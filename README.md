...
| `update_experience` | patch a note by id — only the fields you pass change; answer a gap by filling its beat |
| `confirm_experience` | flip `draft → confirmed` by id; refuses + reports why if action/result thin or gaps remain |
